...
/* Copyright 2016  xhhjin  (email : xhhjin@gmail.com)
...
<br/><b>使用说明：</b>博客同步地址即是 Metaweblog API 的地址
<br/> CSDN博客请填写同步地址为 http://write.blog.csdn.net/xmlrpc/index
<br/><br/><b>问题反馈：</b> <a href="http://xuhehuan.com/2027.html" target="_blank">http://xuhehuan.com/2027.html</a>
</div>
...
function publish_article_to_csdnblog($post_ID)
{
		...
		'publish_post' !== current_filter()))
	{
		...
		//<pre> content </pre>
		$contentPre = "<pre>" . $content . "</pre>";
		$contentRich = wp_richedit_pre($content);
		$contentRich = htmlspecialchars_decode($contentRich);
